 ...
 *
 * Scope guards:
 *   - cloze/translation ONLY — `sentence_construction` keeps its pilot brake
 *     (`SENTENCE_CONSTRUCTION_PILOT_TARGET`) until eval:gen confirms the SC
 *     prompt fix; vocab umbrellas can't carry the flag (curriculum invariant).
