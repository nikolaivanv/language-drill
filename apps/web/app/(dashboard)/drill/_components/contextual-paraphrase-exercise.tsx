...
export function ContextualParaphraseExercise({
  ...
  return (
    <div className="flex flex-col gap-s-4">
          ...
          <div className="flex flex-col gap-s-1">
            ...
            <div className="flex flex-wrap gap-s-2">
              {content.bannedTerms.map((t) => (
                <span
                  key={t}
                  className="t-small rounded-full bg-paper-2 px-s-3 py-s-1 line-through"
                >
                  {t}
                </span>
              ))}
      ...
      {exampleShown && (
        <p className="t-small text-ink-mute">
          e.g. {content.referenceParaphrases[0]}
        </p>
      )}
      {!exampleShown && (
        <Button
              ...
              <div className="flex flex-col gap-s-4">
                ...
                <Card padding="md" className="bg-paper-2">
                  ...
                  <ul className="mt-s-1 flex flex-col gap-s-1">
                    {content.referenceParaphrases.map((m, i) => (
                      <li key={i}>{m}</li>
                    ))}
                  </ul>
                </Card>
