...
export function ThemeToggle({ className }: { className?: string }) {
  ...
  return (
    <div className={className}>
      <div className="px-[10px] py-[6px] text-[11px] font-semibold uppercase tracking-[1.3px] text-ink-mute">
        appearance
      </div>
        ...
        {OPTIONS.map((opt) => {
          ...
          return (
            <button
              ...
              className={cn(
                'flex min-w-0 flex-col items-center justify-center gap-[6px] rounded-[9px] border px-[4px] py-[9px] text-[13px] font-medium transition-colors duration-150 outline-none focus-visible:shadow-[0_0_0_2px_var(--color-card),0_0_0_4px_var(--color-ink)]',
                active
