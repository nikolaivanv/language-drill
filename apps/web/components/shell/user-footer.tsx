  ...
  return (
    <div ref={ref} className="relative mt-auto pt-[18px] border-t border-rule">
      ...
      >
        ...
        <span className="flex-1 text-left text-[16px] text-ink-2 font-medium truncate">
          {name.toLowerCase()}
        </span>
        <span className="text-ink-mute text-[20px] leading-none" aria-hidden="true">
          ⋯
        </span>
      </button>
      ...
      {open && (
        <div
          role="menu"
          className="absolute bottom-full left-0 mb-1 z-10 w-[264px] bg-card border border-rule rounded-[14px] shadow-2 p-s-2"
        >
          <ThemeToggle />
          ...
          <Link
            ...
            className="block px-[12px] py-[11px] rounded-[9px] text-[15px] font-medium text-ink hover:bg-paper-2 transition-colors duration-150 focus-visible:outline-none focus-visible:shadow-[0_0_0_3px_var(--ring-app)]"
          >
            settings
          </Link>
          <button
            ...
            className="w-full text-left px-[12px] py-[11px] rounded-[9px] text-[15px] font-medium text-ink hover:bg-paper-2 transition-colors duration-150 focus-visible:outline-none focus-visible:shadow-[0_0_0_3px_var(--ring-app)]"
          >
            sign out
          </button>
        </div>
