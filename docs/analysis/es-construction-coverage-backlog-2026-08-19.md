...
- Needs authoring: **71** · needs topping up: **3** · needs only the repass: **16**
...
### AUTHOR-1. `es-b1-discourse-connectors` — Discourse connectors: sin embargo, o sea que, causal como, por + infinitivo, aunque + indicative
...
### AUTHOR-2. `es-a1-noun-gender` — Noun gender
...
### AUTHOR-3. `es-a1-noun-plural` — Noun plural
...
### AUTHOR-4. `es-a2-estar-gerundio` — Estar + gerundio
...
### AUTHOR-5. `es-a2-exclamatives-impersonals` — Exclamatives with qué and impersonal weather expressions
...
### AUTHOR-6. `es-a2-mente-adverbs` — Adverbs in -mente
...
### AUTHOR-7. `es-a2-present-irregular-stem-changes` — Present indicative — irregular stem changes
...
### AUTHOR-8. `es-b1-aspectual-periphrases` — Aspectual periphrases: dejar de, ponerse a, estar a punto de, seguir + gerundio
...
### AUTHOR-9. `es-b2-clitic-advanced` — Advanced clitics: neuter lo, fronted-object doubling, leísmo de persona
...
### AUTHOR-10. `es-a2-articles-use` — Article use and omission
...
### AUTHOR-11. `es-a2-imperative-affirmative` — Affirmative imperative
...
### AUTHOR-12. `es-a2-indefinites-double-negation` — Indefinite/negative pairs and double negation
...
### AUTHOR-13. `es-a2-personal-a` — Personal a
...
### AUTHOR-14. `es-b1-superlatives-comparisons` — Superlatives and comparisons: el más/menos…de, -ísimo, igual de…que, más/menos de
...
### AUTHOR-15. `es-b1-verb-preposition-regime` — Verb + preposition regime
...
### AUTHOR-16. `es-a1-gender-agreement` — Noun-adjective agreement
...
### AUTHOR-17. `es-a1-querer-poder-infinitive` — Querer and poder with the infinitive
...
### AUTHOR-18. `es-b1-preterite-imperfect-meaning` — Meaning-changing preterite vs. imperfect

- **B1** · mechanism: **coverage-spec** · cells: cloze (2 of 6), translation (2 of 6)
- Under-represented:
...
### AUTHOR-19. `es-b2-passive-voice` — Passive voice: ser vs estar + participle
...
### AUTHOR-20. `es-b2-perception-verbs` — Ver/oír + infinitive or gerund
...
### AUTHOR-21. `es-a2-connectors` — Connectors: e/u substitution, por eso, entonces
...
### AUTHOR-22. `es-a2-imperfect` — Imperfect
...
### AUTHOR-23. `es-a2-reflexive-verbs` — Reflexive verbs
...
### AUTHOR-24. `es-a2-temporal-clauses` — Temporal clauses: cuando, antes de, después de, desde, hasta
...
### AUTHOR-25. `es-a2-tonic-pronouns-prepositions` — Tonic pronouns after prepositions
...
### AUTHOR-26. `es-a1-possessives-atonic` — Possessive adjectives (short forms)
...
### AUTHOR-27. `es-a2-cada-mismo` — Cada and mismo
...
### AUTHOR-28. `es-b2-gerund-participle-constructions` — Adverbial gerund, nada más + infinitive, and predicative participle clauses
...
### AUTHOR-29. `es-b2-subjunctive-negated-opinion` — Subjunctive after negated opinion and assertion
...
### AUTHOR-30. `es-b2-subjunctive-temporal-concessive` — Subjunctive in temporal and concessive connectors
...
### AUTHOR-31. `es-b2-quantifiers-advanced` — Advanced quantifiers: cualquier(a), partitives, multiplicatives, algo + adjective
...
### AUTHOR-32. `es-b2-relative-clauses-advanced` — Advanced relative clauses
...
### AUTHOR-33. `es-a1-articles` — Definite and indefinite articles
...
### AUTHOR-34. `es-b2-lo-nominalizer` — Lo as nominalizer: lo + adjective, lo de, lo que, lo + adj + que
...
### AUTHOR-35. `es-a1-demonstratives` — Demonstratives
...
### AUTHOR-36. `es-a2-preterito-perfecto` — Pretérito perfecto
...
### AUTHOR-37. `es-b1-deber-obligation-probability` — Deber + infinitivo vs. deber de + infinitivo
...
### AUTHOR-38. `es-b2-gradual-gerund` — Ir/venir + gerundio (gradual action)
...
### AUTHOR-39. `es-b2-nosotros-imperative` — Nosotros imperative (¡Empecemos!)
...
### AUTHOR-40. `es-a1-interrogatives` — Question words
...
### AUTHOR-41. `es-a1-subject-pronouns` — Subject pronouns
...
### AUTHOR-42. `es-a2-comparatives-superlatives` — Comparatives
...
### AUTHOR-43. `es-a2-hace-ago` — Hace + time period = "ago"
...
### AUTHOR-44. `es-a2-indirect-object-pronouns-se` — Indirect object pronouns and se

- **A2** · mechanism: **construction-variants** · cells: cloze (1 of 5), translation (1 of 5)
- Under-represented:
  - `clitic-order-se-first` — Fixed clitic cluster order: se > te/os > me/nos > lo/la/los/las — **0/24**

### AUTHOR-45. `es-a2-ir-a-future` — Ir a + infinitive

- **A2** · mechanism: **construction-variants** · cells: cloze (1 of 2), translation (1 of 2)
- Under-represented:
  - `present-indicative-future-marker` — Present indicative + future time expression (mañana salgo) — **0/24**

### AUTHOR-46. `es-a2-preterite-strong-stems` — Preterite — strong stems (pude, puse, dije...)
...
### AUTHOR-47. `es-b1-ser-location-events` — Ser for the location of events

- **B1** · mechanism: **construction-variants** · cells: cloze (1 of 3), translation (1 of 3)
- Under-represented:
  - `ser-event-time` — Ser for the time of an event — **0/24**

### AUTHOR-48. `es-b1-subjunctive-adverbial` — Subjunctive in adverbial clauses
...
### AUTHOR-49. `es-b2-complex-conditionals` — Complex conditional sentences
...
### AUTHOR-50. `es-b2-conditional-perfect` — Conditional perfect

- **B2** · mechanism: **construction-variants** · cells: cloze (1 of 3), translation (1 of 3)
- Under-represented:
  - `conditional-perfect-standalone` — Standalone conditional perfect (hypothetical past) — **0/24**

### AUTHOR-51. `es-b2-cuyo` — Relative possessive cuyo
...
### AUTHOR-52. `es-a1-present-indicative-regular` — Present indicative (regular verbs)
...
### AUTHOR-53. `es-a1-locative-prepositions` — Locative prepositional phrases
...
### AUTHOR-54. `es-a1-noun-modifiers-de` — Noun modifiers with de and con
...
### AUTHOR-55. `es-a2-preterite-yo-spelling` — Preterite — yo-form spelling changes (-qué/-gué/-cé)

- **A2** · mechanism: **coverage-spec** · cells: translation (1 of 4)
- Under-represented:
  - `gar-gue` — -gar → -gué (e.g. llegar → llegué) — **0/12**

### AUTHOR-56. `es-a2-saber-poder-ability` — Saber vs. poder for ability
...
### AUTHOR-57. `es-a2-todo-otro-quantifiers` — Todo, otro, demasiado, nada/nadie
...
### AUTHOR-58. `es-b1-futuro-simple` — Future simple

- **B1** · mechanism: **construction-variants** · cells: cloze (1 of 3)
- Under-represented:
  - `futuro-probabilidad` — Future of probability (epistemic future) — **0/24**

### AUTHOR-59. `es-b1-indirect-questions` — Indirect questions: si, qué, cuándo, dónde + clause or infinitivo
...
### AUTHOR-60. `es-b1-past-narration` — Past narration: imperfecto/indefinido interplay
...
### AUTHOR-61. `es-b2-adjective-position` — Adjective position and meaning
...
### AUTHOR-62. `es-b2-nuanced-ser-estar` — Nuanced ser vs. estar
...
### AUTHOR-63. `es-b2-reported-speech-backshift` — Reported speech — full backshift
...
### AUTHOR-64. `es-b2-causal-connectors` — Formal causal connectors: ya que, puesto que, debido a que, enunciative porque
...
### AUTHOR-65. `es-a2-gustar-type-verbs` — Gustar-type verbs (extended)
...
### AUTHOR-66. `es-a2-preterite-irregular` — Preterite — irregular verbs
...
### AUTHOR-67. `es-b1-nominalizers` — Nominalizers el de / el que ("the one...")

- **B1** · mechanism: **construction-variants** · cells: cloze (1 of 5), translation (1 of 5)
- Under-represented:
  - `adjective-nominalizer` — Article/determiner + adjective (adjectival nominalizer) — **1/24**

### AUTHOR-68. `es-b1-ser-estar-uses` — Ser/estar special uses: impersonal time, estar de + occupation, estar a + price/date
...
### AUTHOR-69. `es-b2-cleft-sentences` — Cleft sentences: ser-focus with relator agreement

- **B2** · mechanism: **construction-variants** · cells: translation (1 of 7)
- Under-represented:
  - `cleft-time-cuando` — Time-focus cleft with cuando — **1/24**

### AUTHOR-70. `es-b2-past-subjunctive` — Past (imperfect) subjunctive
...
### AUTHOR-71. `es-b2-subjunctive-compound` — Compound subjunctive: perfect and pluperfect
...
### TOP-UP-3. `es-b2-verbs-of-change` — Verbs of becoming: ponerse, quedarse, hacerse, volverse, convertirse en, llegar a ser
...
### REPASS-6. `es-a1-coordination-basic` — Basic coordinators: y, o, pero, ni, unos...otros
...
### REPASS-7. `es-b1-reported-speech` — Reported speech: backshift, no-shift, and reported commands
...
### REPASS-8. `es-a1-ser-estar-basic` — Ser and estar (basic contrast)
...
### REPASS-9. `es-b1-passive-se` — Passive and impersonal "se"
...
### REPASS-10. `es-b2-comparatives-advanced` — Advanced comparatives: de lo que, superior/inferior a, el doble de, igual que
...
### REPASS-11. `es-b2-se-middle-accidental` — Middle se and accidental se (dative of interest)
...
### REPASS-12. `es-a1-porque-para` — Porque, para + infinitive, and por qué
...
### REPASS-13. `es-b1-impersonal-plural` — Impersonal third-person plural for unspecified agents

- **B1** · mechanism: **construction-variants** · cells: cloze (1 of 3), translation (1 of 3)
- Under-represented:
  - `impersonal-uno-una` — uno/una + 3sg verb for generic agent — **0/24**

### REPASS-14. `es-b1-que-vs-cual` — Qué vs. cuál/cuáles
...
### REPASS-15. `es-a1-quantifiers-muy-mucho` — Quantifiers and muy vs. mucho

- **A1** · mechanism: **construction-variants** · cells: cloze (1 of 3)
- Under-represented:
  - `mucho-after-verb` — mucho as invariable adverb after a verb — **0/16**

### REPASS-16. `es-b1-imperative-negative-pronouns` — Negative imperative and clitic pronoun placement
