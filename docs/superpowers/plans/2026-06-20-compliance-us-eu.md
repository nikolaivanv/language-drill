...
describe('legal pages', () => {
  it('privacy page names the controller, contact, and a sub-processor', () => {
    render(<PrivacyPage />);
    expect(screen.getByText(/Ivan Nikola/)).toBeInTheDocument();
    expect(screen.getByText(/info@langdrill\.app/)).toBeInTheDocument();
