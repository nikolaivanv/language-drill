...
- [ ] 7. Scaffold `packages/shared` package
...
- [ ] 8. Create shared types and enums in `packages/shared`
...
- [ ] 9. Add unit tests for `packages/shared`
...
- [ ] 10. Scaffold `packages/db` package
...
- [ ] 11. Create Drizzle database client factory
...
- [ ] 12. Create Drizzle schema — `users` and `user_language_profiles` tables
...
- [ ] 13. Create Drizzle schema — `skills` and `skill_topics` tables
...
- [ ] 14. Create Drizzle schema — `exercises` and `exercise_tags` tables
...
- [ ] 15. Create Drizzle schema — `user_exercise_history` and `spaced_repetition_cards` tables
...
- [ ] 16. Create Drizzle schema — `playlists` and `playlist_items` tables
...
- [ ] 17. Create Drizzle schema — `invitations` and `usage_events` tables
...
- [ ] 18. Create Drizzle schema index and database indexes
...
- [ ] 19. Configure `drizzle.config.ts` for migrations
...
- [ ] 22a. Scaffold `packages/api-client` package files
...
- [ ] 22b. Create health schema and `useHealth` hook in `packages/api-client`
...
- [ ] 24. Create Hono app entry point and Lambda adapter
...
- [ ] 26. Create Hono auth middleware
...
- [ ] 27. Create Hono invite middleware
...
- [ ] 29. Create Clerk webhook handler
...
- [ ] 30. Add unit tests for invite and auth middleware
...
- [ ] 30b. Add unit test for health-check route
...
- [ ] 31. Scaffold `apps/web` Next.js app
...
- [ ] 32. Create Clerk middleware for Next.js
...
- [ ] 33. Create root layout with `ClerkProvider`
...
- [ ] 37. Create `apps/web` `.env.example`
...
- [ ] 38a. Scaffold CDK package boilerplate
...
- [ ] 38b. Create CDK entry point `infra/bin/app.ts`
...
- [ ] 39. Create CDK Lambda construct
...
- [ ] 40. Create CDK API Gateway construct
...
- [ ] 41. Create CDK S3 and SQS constructs
...
- [ ] 45. Create production deploy workflow
...
- [ ] 46. Create PR cleanup workflow
  - File: `.github/workflows/cleanup.yml`
  - Trigger: `pull_request` (closed)
  - Job: delete Neon branch `pr-${{ github.event.number }}` via `neonctl`
  - _Requirements: 5.5_

- [ ] 47. Add GitHub Actions secrets documentation
...
- [ ] 47b. Document Clerk dashboard invite configuration
...
- [ ] 48. Run `drizzle-kit generate` and commit initial migration
...
- [ ] 49. Verify `cdk synth` produces valid CloudFormation
...
- [ ] 50. Add `pnpm turbo typecheck` smoke test to verify cross-package types
