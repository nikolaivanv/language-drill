# Dependency Audit Task 3.3

Execute task 3.3 from the dependency-audit spec using the spec-task-executor agent.
...
- `.claude/specs/dependency-audit/tasks.md` — find task 3.3 for exact implementation details
...
**Rules:**
- Implement ONLY task 3.3 — do not proceed to other tasks
...
- After completing the task, check the checkbox in `.claude/specs/dependency-audit/tasks.md` for task 3.3 (change `- [ ]` to `- [x]`)
