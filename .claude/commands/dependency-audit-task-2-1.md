# Dependency Audit Task 2.1

Execute task 2.1 from the dependency-audit spec using the spec-task-executor agent.
...
- `.claude/specs/dependency-audit/tasks.md` — find task 2.1 for exact implementation details
...
**Rules:**
- Implement ONLY task 2.1 — do not proceed to other tasks
...
- After completing the task, check the checkbox in `.claude/specs/dependency-audit/tasks.md` for task 2.1 (change `- [ ]` to `- [x]`)
